...
config-$(call config_package,ath10k,regular) += ATH10K ATH10K_PCI ATH10K_USB ATH10K_SDIO
...
define KernelPackage/ath10k
  ...
  DEPENDS+= @PCI_SUPPORT @USB_SUPPORT +kmod-ath +@DRIVER_11AC_SUPPORT +kmod-usb-core +kmod-mmc \
